...
export default function ClusterContentEditorPage() {
  ...
  // Approve handler — approve and navigate back to the cluster content list
  ...
  }, [projectId, pageId, clusterId, content?.is_approved, approveContent, router]);
    ...
    <div className="max-w-[1600px] mx-auto pb-24">
      ...
      <div className="pt-1 pb-4">
        <div className="flex items-start justify-between">
          <div>
            <Link
              href={`/projects/${projectId}/clusters/${clusterId}/content`}
